...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta property="og:image" content="https://avatars3.githubusercontent.com/u/4732?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="jashkenas/underscore" /><meta property="og:url" content="https://github.com/jashkenas/underscore" /><meta property="og:description" content="underscore - JavaScript&#39;s utility _ belt" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6Mjc4NjYyNDU4OjE5ZjkxYWE5YjAyYmU5Y2U3YjMyNzg1ZmQ2YmEwYWUwMjVlMjM0YWViN2M4NDA1MzUwYmMzMjc3MGJkZTlhNTQ=--3369cf0ee7271c16164f6c606fb96007808b06a0">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="CB7C:2696:3A66174:6D09BDE:5B031F54" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="CB7C:2696:3A66174:6D09BDE:5B031F54" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="26418801" /><meta name="octolytics-actor-login" content="christinaku" /><meta name="octolytics-actor-hash" content="7c4e65bfbda28a615a6755a808b0a8486585ee5b29376933c7df143887d3adda" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="christinaku">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="MzM3OGU5MDk1MTYyMmI3MTNlNDBkZDgzOGI5ODk4M2QzNDhiN2YzYTM4YWU3MzhhNjc0NzgxZDljOTQ5Y2E2MHx7InJlbW90ZV9hZGRyZXNzIjoiMjQuMTAyLjY4LjgzIiwicmVxdWVzdF9pZCI6IkNCN0M6MjY5NjozQTY2MTc0OjZEMDlCREU6NUIwMzFGNTQiLCJ0aW1lc3RhbXAiOjE1MjY5MzEyOTMsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="83ac1d587e72b89c34b9411938804cd7f2ce379a">
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="349241" data-scoped-search-url="/jashkenas/underscore/search" data-unscoped-search-url="/search" action="/jashkenas/underscore/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
    <label class="form-control header-search-wrapper  js-chromeless-input-container">
          <a class="header-search-scope no-underline" href="/jashkenas/underscore/blob/master/underscore-min.js">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:26418801" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="details-expanded details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@christinaku" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/26418801?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">christinaku</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/christinaku" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/christinaku?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="SboJGmjCXiM1hw+S5+aRBZb/cShBcXTXWTxnxfdnKRA0zbEf1uquooa3+NDzCvuK99i0YJstGBNlTWU7pnnwBg==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="BBhRznoQkxPqoUcAribH3MCftjkYpsRwKtaqVd4B6Jp5b+nLxDhjklmRsEK6yq1TobhzccL6qLQWp6irjx8xjA==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="tJaETl7mS3ScSoWLqyFDu5YJihFfjr7+Nb2W5AmUQK+3pmwUzsiR1YLypWkw4I6m2NM36dMEQVtdxPosov9DHg==" />      <input type="hidden" name="repository_id" id="repository_id" value="349241" class="form-control" />
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            ...
            aria-label="927 users are watching this repository">
            927
          </a>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/jashkenas/underscore/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="VpAtw+0c0+9oK9fcQafSh42AD4CCopR5+Fm7INDmIAWritlI01xK9SA22BNtHUKp6SlbHnzMet+ctGSdatd2Ug==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/jashkenas/underscore/stargazers"
           aria-label="22919 users starred this repository">
          22,919
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/jashkenas/underscore/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="ykw80wpTF1xWwCPBXRTbH/nkv0WWb62+8qsDD60Fcgr+TosXuR9GQFzoZmYjLXYYMGVwLPF9gxfzEYTeyA4cAQ==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
    ...
    <a href="/jashkenas/underscore/network" class="social-count"
       aria-label="5194 users forked this repository">
      5,194
    </a>
  </li>
</ul>
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/jashkenas">jashkenas</a></span><!--
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /jashkenas/underscore" href="/jashkenas/underscore">
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /jashkenas/underscore/pulse" href="/jashkenas/underscore/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/jashkenas/underscore/blob/3cd55ea9b40044b34bfe1ad90c25eb3ac777b158/underscore-min.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:a794166ceb801fbba53388d33664ed83 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/jashkenas/underscore/tree/1.9.0/underscore-min.js"
              data-name="1.9.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/jashkenas/underscore"><span>underscore</span></a></span></span><span class="separator">/</span><strong class="final-path">underscore-min.js</strong>
    </div>
  </div>


  <include-fragment src="/jashkenas/underscore/contributors/master/underscore-min.js" class="commit-tease">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/jashkenas/underscore/raw/master/underscore-min.js">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/jashkenas/underscore/blame/master/underscore-min.js">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/jashkenas/underscore/commits/master/underscore-min.js">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/jashkenas/underscore/edit/master/underscore-min.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="wVo8uqbW8PwiHvkg4zDSCfC965Tdxb/4QdQvQhGs99gl1olB9XLgM20+XQsFfBo2pii5GU18nLXoJ2WZRUwJgA==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/jashkenas/underscore/delete/master/underscore-min.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="bsGXeVDnfYnRTKc9JelQbqiYX0XzjypJUyPrpBeEGKWX7r5TTGlOiQAs8590UUZq0tOE4Bw5TCCBMEmSrAR7MQ==" />
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span>     Underscore.js 1.9.0</span></td>
      </tr>
      <tr>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" href="/jashkenas/underscore/blame/3cd55ea9b40044b34bfe1ad90c25eb3ac777b158/underscore-min.js">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" href="/jashkenas/underscore/issues/new">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.46274s from unicorn-1338157254-z6csn">GitHub</span>, Inc.</li>
